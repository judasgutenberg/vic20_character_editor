...
19 gosub75:fort=1to8:forr=1to8:m=s+22*t:h=sgn((peek(s+22*r+t))-32):x=x+h*2[pi](r-1
...
38 gosub75:fort=1to8:forr=1to8:h=sgn((peek(s+22*t+r))-32):x=x+h*2[pi](-r+8):next:poket-1+c[?],x:x=0:next
...
59 fort=1to8:forr=0to7:pokes+t*22-r+8,32+128*sgn(peek(t-1+y)and2X(r)):nextr,t:goto8 
60 m=1
